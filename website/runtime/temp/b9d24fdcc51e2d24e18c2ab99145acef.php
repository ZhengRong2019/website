<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:31:"./template/default/company.html";i:1543991376;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\head.htm";i:1544762416;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\left.htm";i:1543743318;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\foot.htm";i:1544762750;}*/ ?>
 <!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
     <img src="http://www.red-model.cn/template/default/images/dealer_tu.jpg" class="img-responsive center-block">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12"><!-- right -->
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 int_text">
             <!--  <dt>
                  <img src="http://www.red-model.cn/template/default/images/logo1.png" class="img-responsive center-block">
              </dd> -->
              <dd><?php echo $cates['content']; ?></dd>
          </div>
        </div>
      </div><!-- end_right -->
  </div>
