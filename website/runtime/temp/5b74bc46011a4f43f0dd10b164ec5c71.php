<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:30:"./template/default/events.html";i:1543991417;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\head.htm";i:1543991951;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\left.htm";i:1543743318;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\foot.htm";i:1544597347;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
     ...
     <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 sousuo">
               <a href=""><li class="iconfont icon-tuite_twitter fe"></li></a>
               <a href=""><li class="iconfont icon-linkedin in"></li></a>
               <a href=""><li class="iconfont icon-facebook f"></li></a>
               <div class="border_s">
                  <form>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
     <img src="http://www.red-model.cn/template/default/images/dealer_tu.jpg" class="img-responsive center-block">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12"><!-- right -->
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 en_title">
             <?php echo $arts['title']; ?>
          </div>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 en_text">
        ...
        <div class="row"><!-- 大屏显示开始 -->
          ...
          <?php if(is_array($bottomRes) || $bottomRes instanceof \think\Collection || $bottomRes instanceof \think\Paginator): $i = 0; $__LIST__ = $bottomRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bott): $mod = ($i % 2 );++$i;if($bott['sort'] == 1): ?>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 bt_text ">
                <dl class="row bt_zhx">
                  <dt class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><?php echo $bott['bottom_name']; ?></dt>
           ...
           <?php else: ?>
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 bt_text">
                 <dl class="bt_zhx">
                  <dt><?php echo $bott['bottom_name']; ?></dt>
                  <?php if(is_array($bottomRe) || $bottomRe instanceof \think\Collection || $bottomRe instanceof \think\Paginator): $i = 0; $__LIST__ = $bottomRe;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$botto): $mod = ($i % 2 );++$i;if($botto['bottom_id'] == $bott['id']): ?>
