    ...
    <div class="main-container container-fluid">
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body"> 
<button type="button" tooltip="添加栏目" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('xilie/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>             
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                              ...
                              <?php if(is_array($xilieRes) || $xilieRes instanceof \think\Collection || $xilieRes instanceof \think\Paginator): $i = 0; $__LIST__ = $xilieRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xi): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td align="center"><?php echo $xi['id']; ?></td>
                                    <td align="center"><?php echo $xi['xile_name']; ?></td>
                                    <?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;if($cate['id'] == $xi['xilie_cate']): ?>
                                    <td align="center"><?php echo $cate['cate_name']; ?></td>
                                    <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                    <td align="center">
                                       <a href="<?php echo url('hwadmin/xilie/edit',array('id'=>$xi['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('hwadmin/xilie/del',array('id'=>$xi['id'])); ?>')" class="btn btn-danger btn-sm shiny">
