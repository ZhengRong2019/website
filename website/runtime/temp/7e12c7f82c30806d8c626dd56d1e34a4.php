    ...
    <div class="main-container container-fluid">
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">   
<button type="button" tooltip="添加" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href ='<?php echo url('hwadmin/Product/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>             
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-body">
                        ...
                        <tbody>
                            ...
                            <?php if(is_array($productRes) || $productRes instanceof \think\Collection || $productRes instanceof \think\Paginator): $i = 0; $__LIST__ = $productRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pro): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td align="center"><?php echo $pro['name_title']; ?></td>
                                    <?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;if($pro['cate_id'] == $cate['id']): ?>
                                     <td align="center"><?php echo $cate['cate_name']; ?></td>
                                    <?php endif; endforeach; endif; else: echo "" ;endif; if(is_array($xilieRes) || $xilieRes instanceof \think\Collection || $xilieRes instanceof \think\Paginator): $i = 0; $__LIST__ = $xilieRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xi): $mod = ($i % 2 );++$i;if($xi['id'] == $pro['xi_id']): ?>
                                     <td align="center"><?php echo $xi['xile_name']; ?></td>
                                    <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                     <td align="center"><?php if($pro['img']): ?><img src="http://www.red-model.cn/public/static/admin/uploads/<?php echo $pro['img']; ?>" width="50"> <?php else: ?>暂无图<?php endif; ?></td>

                                     <td align="center"><?php if($pro['sort'] == 1): ?> 显示<?php else: ?>隐藏<?php endif; ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('hwadmin/Product/edit',array('id'=>$pro['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('hwadmin/Product/del',array('id'=>$pro['id'])); ?>')" class="btn btn-danger btn-sm shiny">
                ...
                <div><?php echo $productRes->render(); ?></div>
            </div>
        </div>
    </div>
</div>
