                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                               ...
                               <?php if(is_array($aboutRes) || $aboutRes instanceof \think\Collection || $aboutRes instanceof \think\Paginator): $i = 0; $__LIST__ = $aboutRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td align="center"><?php echo $cate['id']; ?></td>
                                    <td align="center"><a href="<?php echo url('hwadmin/About/edit',array('id'=>$cate['id'])); ?>"><?php echo $cate['title']; ?></a></td>
                                    <td align="center">
                                        <a href="<?php echo url('hwadmin/About/edit',array('id'=>$cate['id'])); ?>" class="btn btn-primary btn-sm shiny">
