                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                               ...
                               <?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;if($cate['language'] == 1): ?>
                                <tr>
                                    <td align="center"><?php echo $cate['id']; ?></td>
                                    <td align="center"><a href="<?php echo url('hwadmin/Content/lsta',array('topid'=>$cate['id'],'pid'=>$cate['pid'])); ?>"><?php echo $cate['cate_name']; ?></a></td>
                                    <td align="center">
                                        <a href="<?php echo url('hwadmin/Content/lsta',array('topid'=>$cate['pid'],'cate_id'=>$cate['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 查看文章列表
                                        </a>
                                        <a href="<?php echo url('hwadmin/Cate/edit',array('id'=>$cate['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                          <i class="fa fa-edit"></i> 栏目编辑
                                        </a>
                                    </td>
                                </tr>
