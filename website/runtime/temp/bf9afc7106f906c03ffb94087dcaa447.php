<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:29:"./template/default/sales.html";i:1544498372;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\head.htm";i:1544762416;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\left.htm";i:1543743318;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\foot.htm";i:1544762750;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
     ...
     <img src="http://www.red-model.cn/template/default/images/dealer_tu.jpg" class="img-responsive center-block">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12"><!-- right -->
        ...
        <div class="row  De_top">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 Sal_text"><!-- 第1组开始 -->
            <li><img src="http://www.red-model.cn/public/static/admin/uploads/<?php echo $zhan['litpic']; ?>" class="img-responsive"></li>
            <dl>
              <dt><?php echo $zhan['title']; ?></dt>
              <h4><?php echo $zhan['description']; ?></h4>
              <dd><i class="iconfont icon-dianhua2 "></i><?php echo $zhan['photo']; ?></dd>
