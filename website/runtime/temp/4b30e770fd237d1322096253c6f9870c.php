    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo $xilieRe['id']; ?>">
                            ...
                            <div class="tab-content tabs-flat">
                                <div id="home11" class="tab-pane active">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control"  name="xile_name" value="<?php echo $xilieRe['xile_name']; ?>"  type="text">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="xilie_cate">
                                                <option selected="selected" value="">请选择</option>
                                                <?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                                                <option {if condition="$cate['id'] eq $xilieRe['xilie_cate']"} selected="selected" value="<?php echo $cate['id']; ?>"><?php echo $cate['cate_name']; ?></option>
