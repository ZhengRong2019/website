                            ...
                            <div class="tab-content tabs-flat">
                                <div id="home11" class="tab-pane active">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="topid">
                                                ...
                                                <option <?php if($cate['id'] == $topid): ?> selected="selected" <?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo str_repeat('-', $cate['level']*8);?><?php echo $cate['cate_name']; ?></option>
                                        ...
                                        <div class="col-sm-3">
                                            <select name="cate_id">
                                                <?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                                                <option <?php if($cate['id'] == $cate_id): ?> selected="selected" <?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo str_repeat('-', $cate['level']*8);?><?php echo $cate['cate_name']; ?></option>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="topid">
                                                ...
                                                <option  value="<?php echo $xi['id']; ?>"><?php echo $xi['xile_name']; ?></option>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control"  name="writer" placeholder="正荣网际"  value="" type="text">
                                        </div>
                                        <label for="username" class="col-sm-2 control-label no-padding-right">来源</label>
                                        <div class="col-sm-2">
                                            <input class="form-control"  placeholder="正荣网际"  value="" name="source"  type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control"  name="booth"  type="text">
                                        </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control"  name="booth_number"  type="text">
                                        </div>
                                        <p class="help-block col-sm-4 red"></p>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control"  name="web_address"  type="text">
                                        </div>
                                        <p class="help-block col-sm-4 red"></p>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="radio" style="float:left; padding-left:10px;">
                                                <label>
                                                    <input name="attr" value="文章推荐" class="colored-blue" type="radio">
                                            ...
                                            <div class="radio" style="float:left; padding-left:10px;">
                                                <label>
                                                    <input name="attr" value="文章热门" class="colored-blue" type="radio">
                                                    <span class="text">文章热门</span>
                                                </label>
                                            </div>
                                            <div class="radio" style="float:left; padding-left:10px;">
                                                <label>
                                                    <input name="attr" value="文章置顶" class="colored-blue" type="radio">
