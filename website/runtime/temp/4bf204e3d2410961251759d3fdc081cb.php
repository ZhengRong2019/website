    ...
    <div class="main-container container-fluid">
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">
  <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Bottom/adda',array('aid'=>$aid)); ?>'"> <i class="fa fa-plus"></i> Add
</button>                  
<div class="row">
                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content tabs-flat">
                            ...
                            <div id="home11" class="tab-pane active">
                                        ...
                                        <div class="flip-scroll">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                 ...
                                                 <?php if(is_array($botRes) || $botRes instanceof \think\Collection || $botRes instanceof \think\Paginator): $i = 0; $__LIST__ = $botRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bot): $mod = ($i % 2 );++$i;?>     
                                                <tr>
                                                   <td align="center"><?php echo $bot['id']; ?></td>
                                                   <td align="center"><?php echo $bot['bo_name']; ?></td>
                                                   <td align="center"><?php echo $bot['bo_url']; ?></td>

                                                   <?php if(is_array($bottomRes) || $bottomRes instanceof \think\Collection || $bottomRes instanceof \think\Paginator): $i = 0; $__LIST__ = $bottomRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bo): $mod = ($i % 2 );++$i;if($bo['id'] == $bot['bottom_id']): ?>
                                                     <td align="center"><?php echo $bo['bottom_name'];?></td>
                                                    <?php endif; endforeach; endif; else: echo "" ;endif; ?>

                                                   <td align="center"><?php if($bot['sort'] == 1): ?> 启用 <?php else: ?> 禁用<?php endif; ?></td>
                                                   <td align="center">
                                                    
                                                        <a href="<?php echo url('edita',array('id'=>$bot['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('dela',array('id'=>$bot['id'])); ?>')" class="btn btn-danger btn-sm shiny">
                             ...
                             <div><?php echo $botRes->render(); ?></div>
                        </div>
                    </div>
                </div>
