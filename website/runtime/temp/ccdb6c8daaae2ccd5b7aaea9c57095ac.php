<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:34:"./template/default/eventslist.html";i:1543991422;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\head.htm";i:1544762416;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\left.htm";i:1543743318;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\foot.htm";i:1544762750;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
     <img src="http://www.red-model.cn/template/default/images/dealer_tu.jpg" class="img-responsive center-block">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12"><!-- right -->
        <div class="row">
          <div class="col-lg12 col-md-12 col-sm-12 col-xs-12 even_title">
          ...
          <a href="<?php echo url('index/Article/index',array('aid'=>$zhan['id'])); ?>"><!-- 第1组 -->
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 even_img">
              <img src="http://www.red-model.cn/public/static/admin/uploads/<?php echo $zhan['litpic']; ?>" class="img-responsive center-block">
            </div>
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 even_text">
              <dt><?php echo $zhan['title']; ?></dt>
              <dd>
               <?php echo cut_str($zhan['description'],150);?>
              </dd>
            </div>
          </a>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 even_hx"></div><!-- end_第1组 -->
          <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
      </div><!-- end_right -->
  </div>
