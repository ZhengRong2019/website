    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改底部</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                      <input type="hidden" name="id" value="<?php echo $bottomRe['id']; ?>">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="bottom_name"  value="<?php echo $bottomRe['bottom_name']; ?>" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="bottom_url" value="<?php echo $bottomRe['bottom_url']; ?>"  type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">语言选择</label>
                            <div class="col-sm-6">
                                <select name="bottom_language" style="width: 100%;">
                                    <option <?php if($bottomRe['bottom_language'] == 1): ?> selected="selected" <?php endif; ?> value="1">英语</option>
                                    <option <?php if($bottomRe['bottom_language'] == 2): ?> selected="selected" <?php endif; ?>  value="2">法语</option>
                                    <option <?php if($bottomRe['bottom_language'] == 3): ?> selected="selected" <?php endif; ?>  value="3">俄语</option>
                                    <option <?php if($bottomRe['bottom_language'] == 4): ?> selected="selected" <?php endif; ?>  value="4">西班牙语</option>
                                </select>
                            </div>
                        </div>  
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input class="form-control" placeholder="" name="sort" value="<?php echo $bottomRe['sort']; ?>"  type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
