                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('Index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('Cate/lst'); ?>">广告位管理</a>
                    </li>
                            ...
                            <div class="tab-content tabs-flat">
                                <div id="home11" class="tab-pane active">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control"  name="banner_name"  type="text">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="username" class="col-sm-2 control-label no-padding-right">Banner_LOGO</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="banner_cate">
                                                <option selected="selected"  value="0">首页</option>
