                            ...
                            <div class="tab-content tabs-flat">
                                <div id="home11" class="tab-pane active">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control"  name="xile_name"  type="text">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="xilie_cate">
                                                ...
                                                <option selected="selected" value="<?php echo $cate['id']; ?>"><?php echo $cate['cate_name']; ?></option>
