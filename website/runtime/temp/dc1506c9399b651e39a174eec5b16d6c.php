    ...
    <div class="main-container container-fluid">
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">   
<button type="button" tooltip="添加" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href ='<?php echo url('hwadmin/Banner/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>             
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-body">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">Baner图</th>
                        ...
                        <tbody>
                           ...
                           <?php if(is_array($bannerRes) || $bannerRes instanceof \think\Collection || $bannerRes instanceof \think\Paginator): $i = 0; $__LIST__ = $bannerRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$banner): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td align="center"><?php echo $banner['id']; ?></td>
                                    <td align="center"><a href="<?php echo url('hwadmin/Banner/edit',array('id'=>$banner['id'])); ?>"><?php echo $banner['banner_name']; ?></a></td>
                                    <td align="center">
                                        <?php if($banner['banner_cate'] == 0): ?>
                                        首页
                                        <?php else: if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;if($cate['id'] == $banner['banner_cate']): ?>
                                           <?php echo $cate['cate_name']; endif; endforeach; endif; else: echo "" ;endif; endif; ?>
                                    </td>
                                    <td align="center"><?php if($banner['banner_img']): ?> <img src="http://www.red-model.cn/public/static/admin/uploads/<?php echo $banner['banner_img']; ?>" width="50"> <?php else: ?> 暂无上传<?php endif; ?></td>
                                    <td align="center"><?php if($banner['status'] == 1): ?> 显示 <?php else: ?> 隐藏 <?php endif; ?></td>
                                     <td align="center"><?php echo $banner['sort']; ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('hwadmin/Banner/edit',array('id'=>$banner['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('hwadmin/Banner/del',array('id'=>$banner['id'])); ?>')" class="btn btn-danger btn-sm shiny">
                ...
                <div><?php echo $bannerRes->render(); ?></div>
            </div>
        </div>
    </div>
</div>
