    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增二级底部</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="bo_name"  type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="bo_url"  type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="bottom_id" style="width: 100%;">
                                    ...
                                    <option  <?php if($bo['id'] == $aid): ?> selected="selected"  <?php endif; ?>  value="<?php echo $bo['id']; ?>"><?php echo $bo['bottom_name']; ?></option>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="radio" style="float:left; padding-left:10px;">
                                    <label>
                                        <input name="sort" value="1"  checked="checked" class="colored-blue" type="radio">
                                ...
                                <div class="radio" style="float:left; padding-left:10px;">
                                    <label>
                                        <input name="sort" value="0" class="colored-blue" type="radio">
