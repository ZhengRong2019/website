    ...
    <div class="main-container container-fluid">
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <!-- Page Body -->
                <div class="page-body">   
<button type="button" tooltip="添加" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href ='<?php echo url('hwadmin/Link/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>             
<div class="row">
                        ...
                        <tbody>
                           ...
                           <?php if(is_array($linkRes) || $linkRes instanceof \think\Collection || $linkRes instanceof \think\Paginator): $i = 0; $__LIST__ = $linkRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$link): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td align="center"><?php echo $link['link_name']; ?></td>
                                    <td align="center">
                                        <?php if($link['link_cate'] == 0): ?>
                                        首页
                                        <?php else: if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;if($cate['id'] == $link['link_cate']): ?>
                                           <?php echo $cate['cate_name']; endif; endforeach; endif; else: echo "" ;endif; endif; ?>
                                    </td>
                                    <td align="center"><?php echo $link['link_url']; ?></td>
                                    <td align="center"><?php if($link['status'] == 1): ?> 显示 <?php else: ?> 隐藏 <?php endif; ?></td>
                                     <td align="center"><?php echo $link['sort']; ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('hwadmin/Link/edit',array('id'=>$link['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('hwadmin/Link/del',array('id'=>$link['id'])); ?>')" class="btn btn-danger btn-sm shiny">
