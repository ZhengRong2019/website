                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('Index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('Cate/lst'); ?>">产品管理</a>
                    </li>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo $productRe['id']; ?>">
                            ...
                            <div class="tab-content tabs-flat">
                                <div id="home11" class="tab-pane active">
                                   ...
                                   <div class="form-group">
                                        <label for="username" class="col-sm-2 control-label no-padding-right">产品名称</label>
                                        <div class="col-sm-3">
                                            <input class="form-control"  name="name_title" value="<?php echo $productRe['name_title']; ?>" type="text">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="cate_id">
                                                ...
                                                <option <?php if($cate['id'] == $productRe['cate_id']): ?> selected="selected" <?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo str_repeat('-', $cate['level']*8);?><?php echo $cate['cate_name']; ?></option>
                                    ...
                                    <div class="form-group">
                                        <label for="username" class="col-sm-2 control-label no-padding-right">所属系列</label>
                                        <div class="col-sm-6">
                                            <select name="xi_id">
                                                <option value="0">请选择</option>
                                                <?php if(is_array($xilieRes) || $xilieRes instanceof \think\Collection || $xilieRes instanceof \think\Paginator): $i = 0; $__LIST__ = $xilieRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xi): $mod = ($i % 2 );++$i;?>
                                                
                                                <option <?php if($xi['id'] == $productRe['xi_id']): ?> selected="selected" <?php endif; ?> value="<?php echo $xi['id']; ?>"><?php echo $xi['xile_name']; ?></option>
                                    ...
                                    <div class="form-group">
                                        <label for="username" class="col-sm-2 control-label no-padding-right">产品缩略图</label>
                                        <div class="col-sm-2">
                                            <input name="img"  type="file">
                                        </div>
                                        <p class="help-block col-sm-4 red"><?php if($productRe['img']): ?><img src="http://www.red-model.cn/public/static/admin/uploads/<?php echo $productRe['img']; ?>" width="50"><?php else: ?>暂无上传<?php endif; ?></p>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="radio" style="float:left; padding-left:10px;">
                                                <label>
                                                    <input name="sort" value="1" <?php if($productRe['sort'] == 1): ?>  checked="checked" <?php endif; ?> class="colored-blue" type="radio">
                                            ...
                                            <div class="radio" style="float:left; padding-left:10px;">
                                                <label>
                                                    <input name="sort" <?php if($productRe['sort'] == 0): ?>  checked="checked" <?php endif; ?> value="0" class="colored-blue" type="radio">
                                        ...
                                        <div class="widget flat radius-bordered">
                                            <div class="widget-body">
                                                <div class="widget-main no-padding">
                                                    <textarea id="content" name="content"><?php echo $productRe['content']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
