<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:30:"./template/default/dealer.html";i:1543991412;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\head.htm";i:1544762416;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\left.htm";i:1543743318;s:63:"E:\phpStudy\PHPTutorial\WWW\zhengrong\template\default\foot.htm";i:1544762750;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
    ...
    <link href="http://www.red-model.cn/template/default/css/tubiao.css" rel="stylesheet">
     ...
     <img src="http://www.red-model.cn/template/default/images/dealer_tu.jpg" class="img-responsive center-block">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12"><!-- right -->
        ...
        <div class="row  De_top">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><!-- 第1组 -->
              <img src="http://www.red-model.cn/public/static/admin/uploads/<?php echo $zhan['litpic']; ?>" class="img-responsive"/>
           </div> 
           <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 De_text">
              <a href="#">
                <dl>
                  <dt><?php echo $zhan['title']; ?></dt>
                  <i>
                    <?php echo $zhan['address']; ?>
                  </i>
                  <dd><i class="iconfont icon-dianhua2 "></i><?php echo $zhan['telephone']; ?></dd>
                  <dd><i class="iconfont icon-chuanzhen "></i><?php echo $zhan['fax']; ?></dd>
                  <dd><i class="iconfont icon-youjian"></i><i class="i_color"><?php echo $zhan['email']; ?></i></dd>
                  <dd><i class="iconfont icon-jiantou"></i><i class="i_color"><?php echo $zhan['web_address']; ?></i></dd>
                </dl>
              </a>
           </div>
           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  De_hx"></div> <!-- 第1组结束 -->
           <?php endforeach; endif; else: echo "" ;endif; ?>
